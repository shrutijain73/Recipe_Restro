...
def api_meal_plan():
    data = request.json or {}
    user_email = session.get("email") # Get the logged-in user's actual email
    ...
    try:
        ...
        # Use the session email instead of the hardcoded placeholder
        mailVar = mail(raw_result, user_email) 
